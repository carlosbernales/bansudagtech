                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <div class="card-header" style="display: flex; justify-content: space-between;">
                                ...
                                <button class="btn btn-lightgreen lightgreen-icon-notika"><i class="notika-icon notika-checked"></i></button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tr>
                                    <td><input type="checkbox" name="calamity_id" value="{{ $calamity->id }}"></td>
...
function initMap(location, calamityId) {
    console.log("Location:", location); // Check the location data
