    ...
    <div style="width: 600px; margin: auto; overflow: hidden; border: 1px solid #E5E5E5; background-repeat: no-repeat; background-position: 0px 91px;">
        <table width="600px" cellspacing="0" cellpadding="0" style="position: relative; border: none;">
            <tbody>
                            ...
                            <tr style="text-align: center;">
                                <td>
                                    <p style="font-weight: bold; font-size: 35px;">
                                        <span style="color: #99CC33; font-family: 'Audiowide', sans-serif;">AGTECH</span>
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="background: #fff; font-size: 25px; padding: 0 26px; text-align: center; vertical-align: middle;">
                        <p>
                            Weather for now is not kind for us, please check your farm from time to time!
                            <br>
                ...
                <tr>
                    <td style="background-color: #EEFDEB; margin-top: 10px; padding: 10px; text-align: center;">
                        <p style="font-size: 24px; font-weight: bold; color: #000;">
                            The current temperature on your area, 
                            "@if(!empty($commodity))
                                {{ $commodity }}
                            @endif
                            @if(!empty($farm_type))
                ...
                <tr>
                    <td style="padding: 25px;">
                        <table width="100%" style="border-radius: 5px; border: 1px solid #000; padding: 13px 25px;">
                            <tr>
                                <td style="font-size: 20px; font-weight: 600;">Stay Safe, Stay Informed!</td>
                                <td style="text-align: right;">
                                    <table width="100%;">
                                        <tr>
                                            <td style="text-align: center;">
                                                <a href="http://facebook.com" style="line-height: 0; display: block;">Facebook</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
