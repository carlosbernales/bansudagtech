            ...
            <tbody>
                ...
                <tr>
                    <td style="background-color: #EEFDEB; margin-top: 10px; padding: 10px; text-align: center;">
                        <p style="font-size: 24px; font-weight: bold; color: #000;">{{ $content }}</p>
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="100%" style="border-radius: 5px; border: 1px solid #000; padding: 13px 25px;">
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <table width="100%;">
                                        <tr>
                                            <td style="text-align: center;"><a href="" style="line-height: 0; display: block;"><img src="https://i.postimg.cc/HnPDpXZQ/xxx.png"></a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
