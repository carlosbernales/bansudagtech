              ...
              <div class="row">
                <div class="col-md-4 mb-5">
                  <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="landingpage/assets/img/icons/farmer.svg" height="60" alt="" />
                      <div class="card-body">
                ...
                <div class="col-md-4 mb-5">
                  <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="landingpage/assets/img/icons/growth.svg" height="60" alt="" />
                      <div class="card-body">
                ...
                <div class="col-md-4 mb-5">
                  <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="landingpage/assets/img/icons/planting.svg" height="60" alt="" />
                      <div class="card-body">
            ...
            <div class="col-xl-9 mb-3">
              <div class="row">
                ...
                <div class="col-md-6 mb-5">
                  <div class="card text-white"><img class="card-img" src="landingpage/assets/img/gallery/short-terms.png" alt="..." />
                ...
                <div class="col-md-6 mb-5">
                  <div class="card text-white"><img class="card-img" src="landingpage/assets/img/gallery/fully-funded.png" alt="..." />
        ...
        <div class="container-lg">
          <div class="row justify-content-center">
            <div class="col-sm-8 col-md-9 col-xl-5 text-center pt-8">
              ...
              <p class="mb-5 text-white">Take your pick from the supply chain and participate in agribusiness projects that are backed up not only by AgiTech, but also by the best land, family heritage, innovation and overall superior expertise.</p>
            </div>
      ...
      <section class="py-0" id="contact">
        ...
        <div class="container">
            ...
            <div class="col-12 col-lg-auto mb-3">
              <div class="card bg-success">
                <div class="card-body p-sm-4">
                  <h5 class="text-white">Blog AgiTech</h5>
                  <p class="mb-0 text-white">write email to us<span class="text-white fs--1 fs-sm-1">info@AgiTechfarm.com</span></p><button class="btn btn-light text-success" type="button"> <svg class="bi bi-person me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#76C279" viewBox="0 0 16 16">
          ...
          <div class="row flex-center py-5">
            <div class="col-12 col-sm-8 col-md-6 text-center text-md-start"> <a class="text-decoration-none" href="#"><img class="d-inline-block align-top img-fluid" src="images/agtech.jfif" alt="" width="40" /><span class="text-theme font-monospace fs-3 ps-2">AgiTech</span></a></div>
